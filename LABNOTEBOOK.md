...
Training validates after each epoch and uses mean validation loss across species for model selection. It stops after two consecutive epochs without a strict validation-loss improvement and retains the best-validation delta checkpoint for held-out evaluation and variant scoring.
